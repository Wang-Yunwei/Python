...
from USBDevice import USBDeviceConfig
    ...
    def checkconditon(self):
        ...
        while True:
            ...
            try:
                ...
                #print(self.airstate.getAirConditonState())
        ...
        if result == b'':
            ...
            if len(result) == 0:
                ...
                if commond == self.system_running_commond:
                    ...
                    self.airstate.set_innerMachineRun(result)
                elif commond == self.codeArefaction_commond:
                    self.airstate.set_codeArefaction(result)
                elif commond == self.hotArefaction_commond:
                    self.airstate.set_hotArefaction(result)
                elif commond == self.alarmState_commond:
                    self.airstate.set_alarmState(result)
                elif commond == self.innerHotAlarm_commond:
                    self.airstate.set_innerHotAlarm(result)
                elif commond == self.innerCodeAlarm_commond:
                    self.airstate.set_innerCodeAlarm(result)
                elif commond == self.innerTemperatureError_commond:
                    self.airstate.set_innerTemperatureError(result)
                elif commond == self.codeInvalid_commond:
                    self.airstate.set_codeInvalid(result)
                elif commond == self.hotInvalid_commond:
                    self.airstate.set_hotInvalid(result)
        ...
        if result == b'':
            ...
            if len(result) == 0:
                if commond==self.inner_tem_commond:
                    self.airstate.set_inner_tem("0")
                elif commond==self.inner_hum_commond:
                    self.airstate.set_inner_hum("0")
                elif commond==self.out_tem_commond:
                    self.airstate.set_out_tem("0")
                elif commond==self.out_hum_commond:
                    self.airstate.set_out_hum("0")
            else:
                #print(f"*************{result}")
                if len(result)!=9:
                    #print("---长度不够---")
                ...
                if commond == self.inner_tem_commond:
                    self.airstate.set_inner_tem(result)
                elif commond == self.inner_hum_commond:
                    self.airstate.set_inner_hum(result)
                elif commond == self.out_tem_commond:
                    self.airstate.set_out_tem(result)
                elif commond == self.out_hum_commond:
                    self.airstate.set_out_hum(result)