...
class ConfigIni():
    ...
    def ini_config(self):
        ...
        '''
        config_db = Config()
        result = config_db.getdetail_config()
    ...
    def get_repeat_bar(self):
        config = Config()
        return config.get_repeat_bar()

    def set_repeat_bar(self, value):
        config = Config()
        return config.set_repeat_bar(value)
    def get_night_charge(self):
        config = Config()
        return config.get_night_charge()

    def set_night_charge(self, value):
        config = Config()
        return config.set_night_charge(value)

    def get_night_light_time(self):
        config = Config()
        return config.get_night_light_time()

    def set_night_light_time(self, value):
        config = Config()
        return config.set_night_light_time(value)
    def get_signal_battery_charge(self):
        config = Config()
        return config.get_signal_battery_charge()

    def set_signal_battery_charge(self, value):
        config = Config()
        return config.set_signal_battery_charge(value)
    ...
    def get_aircon485(self):
        config = Config()
        return config.get_aircon485()

    def set_aircon485(self, value):
        config = Config()
        return config.set_aircon485(value)

    def get_meanopen(self):
        config = Config()
        return config.get_meanopen()

    def set_meanopen(self, value):
        config = Config()
        return config.set_meanopen(value)

    def get_alarm(self):
        config = Config()
        return config.get_alarm()

    def set_alarm(self, value):
        config = Config()
        return config.set_alarm(value)
    ...
    def get_td_bar(self):
        config = Config()
        return config.get_td_bar()

    def set_td_bar(self, value):
        config = Config()
        return config.set_td_bar(value)

    def get_blance_charge(self):
        config = Config()
        return config.get_blance_charge()

    def set_blance_charge(self, value):
        config = Config()
        return config.set_blance_charge(value)
